...
function($scope,$rootScope,$http,$timeout){
  ...
  $scope.data = {
    speechText: 'Hi! Welcome to Lexico! We have 3 options for you to explore today. Start a new session, Review your wordlist, Learn about the App.',
	chosenOption:null,
	count:0,
	i:0
  };
   ...
   $scope.record = function() {
	...
	$scope.SwitchFuction = function () {
		...
		case "session":
			...
			$scope.assignTextArea("In this session,you will be asked the synonyms of five words and you will be given the options for each word. Brace yourself! Good luck!");
